...
// components
import { listBureaux, listPointFocaux } from 'src/assets/data/listMembers';
...
export default function ActesTableToolbar({
  filterName,
  isFiltered,
  filterStartDate,
  filterEndDate,
  ...
  return (
    ...
    >
      ...
      >
        {listPointFocaux.map((option) => (
          <MenuItem
            key={option.id}
            value={option.nomResponsable}
            onClick={() => handleSelectWilaya(option.nomResponsable)}
            sx={{
              mx: 1,
              borderRadius: 0.75,
              typography: 'body2',
      ...
      >
        {listBureaux.map((option) => (
          <MenuItem
            key={option.id}
            value={option.nomBureau}
            onClick={() => handleSelectWilaya(option.nomBureau)}
            sx={{
              mx: 1,
              borderRadius: 0.75,
              typography: 'body2',
